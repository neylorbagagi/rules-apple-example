...
bazel_cmd=(
  ...
  "/Users/neylorbagagi/Library/Caches/bazelisk/downloads/sha256/4eafdf54402b4addbe2546b923a054f1823841509d67e179f564032752eb8d39/bin/bazel"
...
"https://github.com/MobileNativeFoundation/rules_xcodeproj/issues/new?template=bug.md" \
  ...
  diff_output=$(
    comm -23 \
      <(printf '%s\n' "${target_ids[@]}" | sort) \
      <(sort "$PROJECT_DIR/bazel-out/darwin_arm64-dbg/bin/external/rules_xcodeproj++internal+rules_xcodeproj_generated/generator/xcodeproj/xcodeproj_target_ids")
  )
